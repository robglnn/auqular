...
function ScreenRecorder({ onRecordingComplete }) {
  ...
  const startRecording = async () => {
    try {
      console.log('Starting screen recording with desktopCapturer...');
      ...
      console.log('Selected screen source:', screenSource.name, screenSource.id);
      
      // Use getUserMedia with Electron-specific constraints
